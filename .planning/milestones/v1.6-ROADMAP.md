...
- [x] **Phase 31: v1 Prep** — Community feature UI removal (Scenes, Rooms, Chat, Fediverse hidden from nav), localhost text fix (completed 2026-02-27)
...
**Plans**: 1 plan
Plans:
- [x] 31-01-PLAN.md — Remove community UI surfaces + fix localhost text
...
**Plans**: 2 plans
Plans:
- [x] 33-01-PLAN.md — Cloudflare Worker: /claim endpoint + CORS fix for Tauri + /admin claim listing
- [x] 33-02-PLAN.md — Mercury: /claim form page + artist page claim link
